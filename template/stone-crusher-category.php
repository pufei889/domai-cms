...
<div class="content">
    ...
    <p class="intro">In the field of building aggregate, Camelway Machinery is always dedicated to manufacturing a full range of crushing equipment including jaw crusher, impact crusher, cone crusher, VSI crusher, hammer crusher and sand making machine to help you gain outstanding crushing effect.</p>
    <?php
    while(have_posts()){
    ?>
